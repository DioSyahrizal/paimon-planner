    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <YStack style={styles.section}>
        ...
        <Text style={styles.hint}>
          Find your UID in-game on the Paimon menu (bottom-right corner). Make sure your Character
          Showcase is set to public.
        </Text>
      </YStack>
      ...
      <YStack style={styles.section}>
        ...
        <Text style={styles.aboutText}>
          Game data from{' '}
          <Text style={styles.link}>genshin.dev</Text>
        </Text>
        <Text style={styles.aboutText}>
          Build guides are curated by you based on community resources (KQM, Genshin Helper Team).
        </Text>
      </YStack>
    </ScrollView>
  )
...
const styles = StyleSheet.create({
  ...
  screenTitle: { color: '#fff', fontSize: 28, fontWeight: '700', marginBottom: 24 },
  section: {
  ...
  sectionTitle: { color: '#c9a227', fontSize: 13, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
